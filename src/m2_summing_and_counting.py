...
def test_sum_more_cosines():
    ...
    # Test 2:
    expected = 1.234808646  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(5,15)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = -.1014566977  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(-12,100)
