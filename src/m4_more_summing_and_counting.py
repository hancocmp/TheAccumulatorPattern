...
def test_count_cosines_from():
    ...
    # Test 4:
    expected = 2
    answer = count_cosines_from(0, 1, 0)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 4
    answer = count_cosines_from(1, 9, 0)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 0
    answer = count_cosines_from(2, 4, 0.66)
...
def test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = 2.928968254  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(1, 10)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)
    # Test 3:
    expected = 0.1806650746  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(51, 60)
